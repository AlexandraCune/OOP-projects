...
public class PriceDistributorsStrategy implements DistributorsStrategy {
    ...
    public PriceDistributorsStrategy(final List<Producers> producersList,
    ...
    public List<Producers> pickProducers() {
        ...
        // la Price Strategy in enunt
        Collections.sort(producersList, new PriceComparator());
